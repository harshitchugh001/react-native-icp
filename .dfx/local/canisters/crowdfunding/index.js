...
export const canisterId = process.env.CROWDFUNDING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./crowdfunding.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the crowdfunding canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./crowdfunding.did.js")._SERVICE>}
 */
